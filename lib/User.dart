...
List<User> demoList = [
  User(code: 'emily001', name: 'Jeff', image: 'assets/people/jeff.jpg', password: 'emily12'),
  User(code: 'james002', name: 'Kendrick', image: 'assets/people/kendrick.jpg', password: 'james34'),
  User(code: 'rachel003', name: 'Michelle', image: 'assets/people/michelle.jpg', password: 'rachel56'),
  User(code: 'bobby004', name: 'Miranda', image: 'assets/people/miranda.jpg', password: 'bobby78' ),
];
